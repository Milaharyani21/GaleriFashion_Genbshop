...
<!--[if gt IE 99]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
      ...
      <title>..:: Galeri Fashion Genbshop ::..</title>
    ...
    <body>
      ...
      <header class="container">      
        <div class="row">
          ...
          <div class="span5 collections">
            ...
            <div>
              <ul class="content rr">
                <li class="current"><a href="">Koleksi Terbaru Tahun 2018</a></li>
      ...
      <footer>
                ...
                <ul class="connect rr">
                  ...
                  <li>
                    <a href="#" class="clearfix">
                      ...
                      <span class="phone-no">089638655945(sms only)</span>
                    </a>
                  </li>
                  <li>
                    <a href="#" class="clearfix">
                      <span class="ir icon mail">Mail</span>
                      <span>milaharyani21@gmail.com</span>
                    </a>
                  </li>
                </ul>
              </div>
        ...
        <div class="bottom">
          Copyright &copy; 2018. GaleriFashion_Genbshop.com
        </div>
      </footer>
